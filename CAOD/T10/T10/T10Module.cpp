...
public:
    ...
    // Деструктор
    // default - деструктор должен быть реальзован компилятором
    // вызываются деструкторы всех полей класса
    ~Stack() = default;
...
void assertCheckA() {
    ...
    stack2 = move(stack3); // Перемещаем стек stack3 обратно в stack2
